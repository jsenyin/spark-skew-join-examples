...
public final class JavaLogQuery {
	private static Logger logger = LoggerFactory.getLogger(JavaLogQuery.class);
	...
	/**
	 * Tracks the total query count and number of aggregate bytes for a
	 * particular group.
	 */
	...
	public static void main(String[] args) {
		...
		JavaSparkContext jsc = SparkUtils.getJavaSparkContext("JavaLogQuery", "local[2]", "WARN");
		...
		JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet
				.mapToPair(new PairFunction<String, Tuple3<String, String, String>, Stats>() {
					...
					public Tuple2<Tuple3<String, String, String>, Stats> call(String s) {
						return new Tuple2<Tuple3<String, String, String>, Stats>(extractKey(s),
								extractStats(s));
					}
				});
